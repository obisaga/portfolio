        ...
        <div className='pageThree'>
            ...
            <div className="containerThree">
                ...
                <div className='aboutSkill'>
                    ...
                    <li className='liSpecial'><span className="colorChange">Tools:</span> Photoshop CorelDraw InDesign <br></br>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Figma Blender</li>
                    ...
                    <img className="diagonal1" src="..\src\assets\lancuch.png" alt="logo" />
